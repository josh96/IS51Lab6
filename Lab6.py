...
otherwise if the numner is > 5, then the result will be "Plum"
otherwise if the number is > 2, then the result will be "Bell"
otherwise if the number is not any of the above, then the results will be "Bar"
